...
main = do
  ...
  (_,_,viola1Data)     <- processFile "./data/misure_viola1.csv"  (simpleParser) (calcLambdas step theta0) (calcLambdaErrors step stepError theta0) (weightedAverage) "A"   (1) (SignificanceTest 4047 0.05)
  (_,_,viola2Data)     <- processFile "./data/misure_viola2.csv"  (simpleParser) (calcLambdas step theta0) (calcLambdaErrors step stepError theta0) (weightedAverage) "A"   (1) (SignificanceTest 4077 0.05)
  (_,_,bluData)        <- processFile "./data/misure_blu.csv"     (simpleParser) (calcLambdas step theta0) (calcLambdaErrors step stepError theta0) (weightedAverage) "A"   (1) (SignificanceTest 4358 0.05)
  (_,_,verdeData)      <- processFile "./data/misure_verde.csv"   (simpleParser) (calcLambdas step theta0) (calcLambdaErrors step stepError theta0) (weightedAverage) "A"   (1) (SignificanceTest 5461 0.05)
  (_,_,giallo1Data)    <- processFile "./data/misure_giallo1.csv" (simpleParser) (calcLambdas step theta0) (calcLambdaErrors step stepError theta0) (weightedAverage) "A"   (1) (SignificanceTest 5770 0.05)
  (_,_,giallo2Data)    <- processFile "./data/misure_giallo2.csv" (simpleParser) (calcLambdas step theta0) (calcLambdaErrors step stepError theta0) (weightedAverage) "A"   (1) (SignificanceTest 5790 0.05)
  (_,_,rossoData)      <- processFile "./data/misure_rosso.csv"   (simpleParser) (calcLambdas step theta0) (calcLambdaErrors step stepError theta0) (weightedAverage) "A"   (1) (NoTest)
